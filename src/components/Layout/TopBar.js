            ...
            <div className="headerLogo">
              <Link to="/">
                <S.HeaderLogo>
                  ...
                  <S.HeaderLogoLabel>Keyswap</S.HeaderLogoLabel>
                  <S.HeaderLogoLabel>NFT</S.HeaderLogoLabel>
            ...
            <div className="headerMenu">
              <div className="innerWrap">
                <div className="col col-1">
                  ...
                  <a href={"https://keyswap.exchange/swap#/swap?outputCurrency=0x07b1681c082039551952bdee4a505cecc2ff4998"} rel="noopener noreferrer" target="_blank" className="menuLink">
                    Buy KEY
                  </a>                  
                </div>                
